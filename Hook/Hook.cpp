...
int WINAPI hook_SetBkMode(HDC hdc, int iBkMode)
{
	return 0;
}
...
// This hook makes the DirectDrawCreate call return an error
...
void hooks()
{
	...
	_SetBkMode = (H_SetBkMode)GetProcAddress(GetModuleHandle("GDI32.dll"), "SetBkMode");
	_SetBkMode = (H_SetBkMode)Detour((BYTE*)_SetBkMode, (BYTE*)&hook_SetBkMode, 5);
